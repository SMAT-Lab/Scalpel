...
class ModuleTree:
    """
    The Module Tree class is a data structure that allows users to manipulate different files under a Python project. 
    Every leaf node in this tree is a source file. By default, it represents .py files. For type stubs, it can be .pyi files
    """
