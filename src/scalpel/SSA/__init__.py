"""
Static Single Assignment (SSA) is a technique of IR in the compiling theory, it also shows great benefits to static anaysis tasks such as constant propagation, dead code elimination and etc.
