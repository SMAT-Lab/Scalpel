...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            final_outputs = final_inputs # signals from final output layer---there is no activation function
            ...
            hidden_error = np.dot(self.weights_hidden_to_output, error) # this is a specific case, because the activation function of the last layer is f(x) = x.
            
            # TODO: Backpropagated error terms - Replace these values with your calculations.
            output_error_term = error # because the derivative of f(x) = x is 1
