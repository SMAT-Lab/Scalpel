...
learning_rate = 0.8  # 0.8  = ~0.07 (TL), ~0.16 (VL) #
hidden_nodes = 13    # 13                            #
output_nodes = 1
...
for ii in range(iterations):
    ...
    sys.stdout.write("\rProgress: {:2.1f}".format(100 * ii/float(iterations))                      + "% ... Training loss: " + str(train_loss.ix[0])[:5]                      + " ... Validation loss: " + str(val_loss.ix[0])[:5])
    sys.stdout.flush()
...
ax.plot(predictions.as_matrix()[0], label='Prediction')
...
# In[15]:
rides.plot(x='dteday', y='cnt', figsize=(16,4))
# In[16]:
fig, ax = plt.subplots(figsize=(8,4))
rides[24*340:24*360].plot(x='dteday', y='cnt', figsize=(8,4), label='2011', ax=ax)
rides[24*704:24*724].plot(x='dteday', y='cnt', figsize=(8,4), label='2012', ax=ax)
# In[17]:
fig, ax = plt.subplots(figsize=(8,4))
rides[24*340:24*360].plot(x='dteday', y='temp', figsize=(8,4), label='2011', ax=ax)
rides[24*704:24*724].plot(x='dteday', y='temp', figsize=(8,4), label='2012', ax=ax)