...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            final_outputs = final_inputs # signals from final output layer, activation function is f=f(x)
            ...
            output_error_term = error * 1 #the derivative of the activation function will eqaul 1, because 
                                        #f=f(x) f'=1
