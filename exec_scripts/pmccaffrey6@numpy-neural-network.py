...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # Set self.output_activation_function to f(x) = x
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            # since self.output_activation_function_prime(final_inputs) = 1
            # then output_error_term = error * self.output_activation_function_prime(final_inputs)
            # is just the same as output_error_term = error
