...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            inp = np.array(X, ndmin=2)
            out = np.array(y, ndmin=2)
#             print ("X :", inp.shape)
#             print("i:h", self.weights_input_to_hidden.shape)
            hidden_inputs =  np.dot(  self.weights_input_to_hidden.T, inp.T)# signals into hidden layer
...
#             print("y : ", y.shape)
            ...
            error = out - final_outputs # Output layer error is the difference between desired target and actual output.
...
#             print(hidden_error_term[:, None].shape)
            delta_weights_i_h += np.dot(inp.T , (hidden_error_term.T))
