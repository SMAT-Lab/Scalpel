...
class BaseCaseTests(unittest.TestCase):
    ...
    def test_case_1(self):
        infferer = TypeInference(name='case1.py', entry_point='test-cases/typeinfer_basecase/case1.py')
    ...
    def test_case_2(self):
        infferer = TypeInference(name='case2.py', entry_point='test-cases/typeinfer_basecase/case2.py')
        infferer.infer_types()
        inferred = infferer.get_types()
        assert inferred == [{'file': 'case2.py', 'line_number': 6, 'function': 'my_function', 'type': {'str'}}]

    def test_case_3(self):
        infferer = TypeInference(name='case3.py', entry_point='test-cases/typeinfer_basecase/case3.py')
        infferer.infer_types()
        inferred = infferer.get_types()
    ...
    def test_case_4(self):
        infferer = TypeInference(name='case4.py', entry_point='test-cases/typeinfer_basecase/case4.py')
        infferer.infer_types()
        inferred = infferer.get_types()
        assert inferred == [{'file': 'case4.py', 'line_number': 12, 'function': 'MyClass.get_hash', 'type': {'Dict[any, any]'}}]

    def test_case_5(self):
        infferer = TypeInference(name='case5.py', entry_point='test-cases/typeinfer_basecase/case5.py')
        infferer.infer_types()
        inferred = infferer.get_types()
    ...
    def test_case_6(self):
        infferer = TypeInference(name='case6.py', entry_point='test-cases/typeinfer_basecase/case6.py')
        infferer.infer_types()
        inferred = infferer.get_types()
    ...
    def test_case_7(self):
        infferer = TypeInference(name='case7.py', entry_point='test-cases/typeinfer_basecase/case7.py')
        infferer.infer_types()
        inferred = infferer.get_types()
        assert inferred == []

    def test_case_8(self):
        infferer = TypeInference(name='case8.py', entry_point='test-cases/typeinfer_basecase/case8.py')
        infferer.infer_types()
        inferred = infferer.get_types()
    ...
    def test_case_9(self):
        infferer = TypeInference(name='case9.py', entry_point='test-cases/typeinfer_basecase/case9.py')
        infferer.infer_types()
        inferred = infferer.get_types()
    ...
    def test_case_10(self):
        infferer = TypeInference(name='case10.py', entry_point='test-cases/typeinfer_basecase/case10.py')
        infferer.infer_types()
        inferred = infferer.get_types()
    ...
    def test_case_11(self):
        infferer = TypeInference(name='case11.py', entry_point='test-cases/typeinfer_basecase/case11.py')
        infferer.infer_types()
        inferred = infferer.get_types()
    ...
    def test_case_12(self):
        infferer = TypeInference(name='case12.py', entry_point='test-cases/typeinfer_basecase/case12.py')
        infferer.infer_types()
        inferred = infferer.get_types()
    ...
    def test_case_13(self):
        infferer = TypeInference(name='case13.py', entry_point='test-cases/typeinfer_basecase/case13.py')
        infferer.infer_types()
        inferred = infferer.get_types()
    ...
    def test_case_14(self):
        infferer = TypeInference(name='case14.py', entry_point='test-cases/typeinfer_basecase/case14.py')
        infferer.infer_types()
        inferred = infferer.get_types()
    ...
    def test_case_15(self):
        infferer = TypeInference(name='case15.py', entry_point='test-cases/typeinfer_basecase/case15.py')
        infferer.infer_types()
        inferred = infferer.get_types()
    ...
    def test_case_16(self):
        inferrer = TypeInference(name='case16', entry_point='test-cases/typeinfer_basecase/case16')
    ...
    def test_case_17(self):
        inferrer = TypeInference(name='case17', entry_point='test-cases/typeinfer_basecase/case17.py')
        inferrer.infer_types()
        inferred = inferrer.get_types()
        print(inferred)
    ...
    def test_case_18(self):
        inferrer = TypeInference(name='case18', entry_point='test-cases/typeinfer_basecase/case18.py')
        inferrer.infer_types()
        inferred = inferrer.get_types()
    ...
    def test_case_19(self):
        ...
        inferrer = TypeInference(name='case18', entry_point='test-cases/typeinfer_basecase/case19.py')
        inferrer.infer_types()
        inferred = inferrer.get_types()
        # self.assertEqual(inferred, [])

    def test_case_20(self):
        inferrer = TypeInference(name='case20', entry_point='test-cases/typeinfer_basecase/case20.py')
        inferrer.infer_types()
        inferred = inferrer.get_types()
    ...
    def test_case_23(self):
        inferrer = TypeInference(name='case23', entry_point='test-cases/typeinfer_basecase/case23.py')
        inferrer.infer_types()
        inferred = inferrer.get_types()
    ...
    def test_case_24(self):
        inferrer = TypeInference(name='case24', entry_point='test-cases/typeinfer_basecase/case24.py')
        inferrer.infer_types()
        inferred = inferrer.get_types()
