...
import unittest
import os
from scalpel.typeinfer.typeinfer import TypeInferenceJedi
...
class DefaultTypeInferer(unittest.TestCase):
    ...
    def test_case_7(self):
        ...
        infferer.infer_types()
        inferred = infferer.get_types()
        assert sorted(inferred, key=lambda x: str(x)) == ActualData.actual_data_case_7()
