...
# Add a fully connected layer with a numbers of units equal to the number of characters. First, parameter is the number of units.
# Second parameter is the activation function to apply, in this case a linear combination.
model.add(Dense(len(chars), activation='linear'))
# Add a softmax activation layer to estimate the probabilities of each character of been the next
